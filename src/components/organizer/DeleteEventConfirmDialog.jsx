      ...
      {open ? (
        ...
        >
          ...
          >
            ...
            >
              ¿Confirmas que deseas eliminar este evento?
            </h2>
            <p className={`mt-4 text-sm leading-relaxed ${mutedCls}`}>
              Si eliminas este evento, se borrará permanentemente de la lista de eventos. Perderás la
              descripción, las imágenes cargadas y todo el histórico de estadísticas acumuladas en tu
              panel. Esta acción es definitiva.
            </p>
