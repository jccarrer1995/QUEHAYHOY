 ...
 * @returns {string}
 */
function getCategoryTypeBadge(categoryId) {
  return CATEGORY_TYPE_BADGE[categoryId] ?? 'Eventos'
}
      ...
      >
        ...
        >
          <PreferenceSettingsPanel
            ...
            subtitle="Activa o desactiva cada categoría para mostrarla u ocultarla en el home junto con sus eventos."
          ...
          >
            {selectableCategories.map((category) => {
              ...
              const typeBadge = getCategoryTypeBadge(category.id)
              ...
              return (
                ...
                >
                  <div className="flex min-w-0 flex-1 items-center gap-3">
                    ...
                    <span className={`truncate text-base font-medium ${labelCls}`}>{category.label}</span>
                  </div>

                  <div className="flex shrink-0 items-center gap-2.5">
                    <span className={badgeCls}>{typeBadge}</span>
                    <PreferenceVisibilitySwitch
                      enabled={enabled}
                      isDark={isDark}
                      label={`Marcar ${category.label} como categoría favorita`}
